...
const impuesto_routes_1 = __importDefault(require("./routes/impuesto.routes"));
const moneda_routes_1 = __importDefault(require("./routes/moneda.routes"));
...
app.use('/api/impuestos', impuesto_routes_1.default);
app.use('/api/monedas', moneda_routes_1.default);
