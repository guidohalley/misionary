...
const ClienteNew: React.FC = () => {
  ...
  const handleSubmit = async (data: ClienteFormData | any) => {
    try {
    ...
    >
      ...
      <div className="mb-6">
        ...
        <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Nuevo Cliente</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Registra un nuevo cliente en el sistema (solo información, sin acceso)
          </p>
        </div>
      </div>
